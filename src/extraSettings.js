...
const maxRandomFruitNum = reverseLevelUp ? 10 : 10; // 生成随机水果最大值（1-11）0 为葡萄，9 为半个西瓜
let setFruits = {
...
// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成柠檬森林-全家福版';
